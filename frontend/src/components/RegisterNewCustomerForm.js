                ...
                <div className="mb-4">
                    <div className="inline">
                        <label className="inline-flex items-center md:w-2/3  pr-6">
                            <input className="form-radio" type="radio" name="company" value={formData.company}
                            ...
                            <div className="">
                                <div
                                    ...
                                    <div className="p-6 flex flex-col justify-start">
                                        <h5 className="text-gray-900 text-xl font-medium mb-2">BEHANDLING AV
                                            PERSONUPPGIFTER OCH SPECIFIKATION</h5>
                                        <p className="text-gray-700 text-base mb-4">
                                            7.1 Personuppgiftsbiträdet ska vidta alla lämpliga tekniska och
                                            organisatoriska säkerhetsåtgärder som krävs enligt Dataskyddslagstiftningen
                                            för att förhindra Personuppgiftsincidenter, genom att säkerställa att
                                            Behandlingen uppfyller kraven i Dataskyddsförordningen och att den
                                            Registrerades rättigheter skyddas.<br/>

                                            7.2 Personuppgiftsbiträdet ska fortlöpande säkerställa att den tekniska och
                                            organisatoriska säkerheten i samband med Behandlingen medför en lämplig nivå
                                            av konfidentialitet, integritet, tillgänglighet och motståndskraft.<br/>

                                            7.3 Eventuella tillkommande eller ändrade krav på skyddsåtgärder från den
                                            Personuppgiftsansvarige, efter parternas tecknande av PUB-avtalet, ska
                                            betraktas som nya Instruktioner enligt PUB-avtalet.
                                        </p>
                                    </div>
                                </div>
                            </div>
